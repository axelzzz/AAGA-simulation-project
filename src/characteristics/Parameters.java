...
public class Parameters {
	...
	public static final double EAST = 0, // clockwise trigonometric unit, according to screen pixel coordinate reference value set according to screen pixel coordinate reference
			WEST = Math.PI, SOUTH = 0.5 * Math.PI, NORTH = -0.5 * Math.PI, RIGHTTURNFULLANGLE = 0.5 * Math.PI,
	...
	public static final String teamAMainBotBrainClassName = "equipes_par_defaut.BootingBerzerk"; // class given by name; is supposed to extends robotsimulator.Brain
	...
	public static final String teamASecondaryBotBrainClassName = "equipes_par_defaut.BootingBerzerk"; // class given by name; is supposed to extends robotsimulator.Brain
	...
	// FifthElementMain HighwayFugitive BootingBerzerk RandomFire BrainCanevas
	public static final String teamBMainBotBrainClassName = "algorithms.teamBMain"; // class given by name; is supposed to extends robotsimulator.Brain
	...
	public static final String teamBSecondaryBotBrainClassName = "algorithms.teamBSecondary"; // class given by name; is supposed to extends robotsimulator.Brain
	...
	// ---BULLET-PARAMETERS---//
	// -----------------------//
	public static final double bulletVelocity = 10, bulletDamage = 10, bulletRadius = 5, bulletRange = 1000;
