...
public class Parameters {
	...
	public static final double EAST = 0, // clockwise trigonometric unit, according to screen pixel coordinate reference
			WEST = Math.PI, SOUTH = 0.5 * Math.PI, NORTH = -0.5 * Math.PI, RIGHTTURNFULLANGLE = 0.5 * Math.PI, // value
																												// set
																												// according
																												// to
																												// screen
	...
	public static final String teamAMainBotBrainClassName = "algorithms.StrategyMainA"; // class given by name; is
																						// supposed to extends
	...
	public static final String teamASecondaryBotBrainClassName = "algorithms.StrategySecondaryA"; // class given by name;
																								// is supposed to
																								// extends
																								// robotsimulator.Brain
