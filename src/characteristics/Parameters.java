...
public class Parameters {
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.BootingBerzerk"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  //---TEAM-B-PARAMETERS---//
  //-----------------------//
  // BootingBerzerk HighwayFugitive RandomFire FifthElementMain FifthElementSecondary
